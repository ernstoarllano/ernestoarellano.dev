const About = () => {
  return (
    <div className="flex flex-col">
      <h1 className="mb-0 text-2xl lg:text-6xl text-night dark:text-day font-bold">
        Ernesto Arellano
      </h1>
      <h2 className="mt-4 text-lg font-semibold text-night dark:text-day leading-tight">
