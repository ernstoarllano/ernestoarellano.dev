...
const Repo = ({
  ...
  return (
    <article
      className="bg-navy-500 transition duration-500 xl:group-hover:opacity-50 xl:hover:opacity-important xl:hover:scale-[1.1] xl:hover:shadow-2xl"
      itemScope
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              className="w-5 h-5 mr-2 fill-day hover:fill-neon-500 transition-colors"
            >
