    ...
    >
      <header className="block relative p-10">
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-bold text-charcoal uppercase tracking-[3px]">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              className="w-5 h-5 mr-2 fill-day hover:fill-dawn transition-all"
            >
        ...
        <h4 className="font-bold text-charcoal" itemProp="name">
          {name}
        </h4>
